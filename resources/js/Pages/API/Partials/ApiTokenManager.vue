...
import type { ApiToken, Nullable } from '@/types';
...
const managingPermissionsFor = ref<Nullable<ApiToken>>(null);
const apiTokenBeingDeleted = ref<Nullable<ApiToken>>(null);
...
<template>
    <div>
            ...
            <template #form>
                ...
                <div class="col-span-6 sm:col-span-4">
                    ...
                    <TextInput
                        ...
                        autofocus
                    />
                    <InputError v-if="createApiTokenForm.errors?.name" :message="createApiTokenForm.errors.name" class="mt-2" />
                </div>

                <!-- Token Permissions -->
                <div v-if="availablePermissions?.length ?? 0 > 0" class="col-span-6">
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #footer>
                <SecondaryButton type="button" @click="displayingToken = false">
                    Close
                </SecondaryButton>
            </template>
        </DialogModal>
        ...
        <DialogModal :show="managingPermissionsFor != null" @close="managingPermissionsFor = null">
            ...
            <template #footer>
                <SecondaryButton type="button" @click="managingPermissionsFor = null">
                    Cancel
                </SecondaryButton>
        ...
        <ConfirmationModal :show="apiTokenBeingDeleted != null" @close="apiTokenBeingDeleted = null">
            ...
            <template #footer>
                <SecondaryButton type="button" @click="apiTokenBeingDeleted = null">
                    Cancel
                </SecondaryButton>
